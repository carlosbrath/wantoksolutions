...
define('WHMCS_URL', 'https://wantoksolutions.com.pg/whmcs/includes/api.php');
define('WHMCS_USERNAME', 'wantokpg'); // username
define('WHMCS_PASSWORD', md5('wantokpg@whmcs')); //password 
